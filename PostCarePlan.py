...
from ApiFunctions import executePost, getRequest
import json
...
print(len(getRequest('CarePlan', f'?subject=Patient/1')))
res = executePost('CarePlan', example)
print(res)
print(len(getRequest('CarePlan', f'?subject=Patient/1')))